...
const run = async () => {
  ...
  await git.checkout(['--orphan', 'reviewa'])
  await git.raw(['rm', '-rf', '.'])
  await git.commit('first commit', { "--allow-empty": true })
  await git.raw(['rebase', '--onto', 'reviewa', '--root', 'master'])
  await git.push('origin', 'master', { "--force": true })
  await git.checkout(['reviewa'])
  await git.push('origin', 'reviewa', { "--force": true })
...
//"reviewa": "node node_modules/elevation-pr/index.js"
